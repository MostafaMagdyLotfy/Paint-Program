 ...
 */
public class Rect implements Shape,Cloneable{
private Point p;
private Color c;
private Color fc;
...
double width;
    ...
    width=m.get("width");
        ...
        int Width=(int)width;
          g.setColor(getColor());
          if(this.fc==null)
   g.draw(new Rectangle2D.Double(p.x, p.y,Length,Width));
          else 
              g.fill(new Rectangle2D.Double(p.x, p.y,Length,Width));
